...
public enum MeEnrichmentChamberJadeProvider implements IBlockComponentProvider, IServerDataProvider<BlockAccessor> {
    INSTANCE;

    private static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(
            MekanismAeMod.MOD_ID, "me_enrichment_chamber_status");
    private static final String DATA_KEY = MekanismAeMod.MOD_ID + ":me_enrichment_chamber";
    ...
    public void appendServerData(CompoundTag data, BlockAccessor accessor) {
        if (!(accessor.getBlockEntity() instanceof MeEnrichmentChamberBlockEntity chamber)) {
            return;
        }
