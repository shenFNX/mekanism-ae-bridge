...
public abstract class AbstractItemChemicalToItemMeMachineJadeProvider
    ...
    protected AbstractItemChemicalToItemMeMachineJadeProvider(String id) {
    ...
    public void appendServerData(CompoundTag data, BlockAccessor accessor) {
        if (!(accessor.getBlockEntity() instanceof AbstractItemChemicalToItemMeMachineBlockEntity machineEntity)) {
            return;
        }
        ...
        MekanismKey chemicalKey = machineEntity.getBufferedChemicalKey();
        if (chemicalKey != null) {
            machine.putString(CHEMICAL, chemicalKey.getId().toString());
            machine.putLong(CHEMICAL_COUNT, machineEntity.getBufferedChemicalCount());
        }
